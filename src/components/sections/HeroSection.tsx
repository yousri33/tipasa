  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-rose-50 via-purple-50 to-cyan-50 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-20">
          <div className={`text-center lg:text-right space-y-10 transition-all duration-1000 ${
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end">
              ...
              <Button variant="outline" size="lg" className="text-lg px-8 py-4 rounded-full border-2 border-gray-300 hover:border-rose-500 hover:text-rose-600 transition-all duration-300 group">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 border-2 border-gray-400 rounded-full flex justify-center cursor-pointer hover:border-rose-400 transition-colors duration-300">
          <div className="w-1 h-3 bg-gray-400 rounded-full mt-2 animate-pulse"></div>
        </div>
        <div className="text-center mt-2 text-sm text-gray-500 animate-pulse">اسحب للأسفل</div>
      </div>
